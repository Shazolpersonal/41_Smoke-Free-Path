...
list = list.replace(/<MilestoneStarburst[\s\S]*?size=\{32\}[\s\S]*?color=\{starColor\}[\s\S]*?hasGlow=\{isAchieved\}[\s\S]*?\/>/, '<MilestoneStarburst size={32} color={starColor} dayNumber={day} />');
