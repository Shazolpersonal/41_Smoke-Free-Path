...
## 2024-05-18 - Missing Input Length Limits (DoS Risk)
**Vulnerability:** Found multiple  components lacking  constraints (e.g., in , , , , ). Unrestricted inputs can be a medium-priority Denial of Service (DoS) and memory exhaustion risk, especially for generic fields or long notes.
**Learning:** React Native  by default does not limit text length. A malicious or accidental massive input string can cause memory spikes or layout thrashing. Reusable inputs should have a generous fallback  (e.g., 1000) to prevent unintended truncation while still enforcing a reasonable bound, and specific fields (like notes or search) should have logical limits.
**Prevention:** Always enforce input validation by explicitly setting  attributes on all  components, especially for user-generated content and reusable form elements.
## 2026-05-18 - Missing Input Length Limits (DoS Risk)
**Vulnerability:** Found multiple TextInput components lacking maxLength constraints (e.g., in FormElements.tsx, FloatingLabelInput.tsx, trigger-log/index.tsx, library.tsx, dua.tsx). Unrestricted inputs can be a medium-priority Denial of Service (DoS) and memory exhaustion risk, especially for generic fields or long notes.
**Learning:** React Native TextInput by default does not limit text length. A malicious or accidental massive input string can cause memory spikes or layout thrashing. Reusable inputs should have a generous fallback maxLength (e.g., 1000) to prevent unintended truncation while still enforcing a reasonable bound, and specific fields (like notes or search) should have logical limits.
**Prevention:** Always enforce input validation by explicitly setting maxLength attributes on all editable TextInput components, especially for user-generated content and reusable form elements.
## 2026-05-18 - Missing Input Length Limits (DoS Risk)
**Vulnerability:** Found multiple TextInput components lacking maxLength constraints (e.g., in FormElements.tsx, FloatingLabelInput.tsx, trigger-log/index.tsx, library.tsx, dua.tsx). Unrestricted inputs can be a medium-priority Denial of Service (DoS) and memory exhaustion risk, especially for generic fields or long notes.
**Learning:** React Native TextInput by default does not limit text length. A malicious or accidental massive input string can cause memory spikes or layout thrashing. Reusable inputs should have a generous fallback maxLength (e.g., 1000) to prevent unintended truncation while still enforcing a reasonable bound, and specific fields (like notes or search) should have logical limits.
**Prevention:** Always enforce input validation by explicitly setting maxLength attributes on all editable TextInput components, especially for user-generated content and reusable form elements.
