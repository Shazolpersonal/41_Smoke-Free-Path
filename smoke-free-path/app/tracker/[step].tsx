  ...
  const handleNextStep = useCallback(() => {
    if (stepNum < 41) {
      if (isStepAccessible(stepNum + 1, planState)) {
        ...
        Alert.alert(
          "অপেক্ষা করুন",
          "আপনি আজকের জন্য নির্ধারিত ধাপ সম্পন্ন করেছেন অথবা আপনার যাত্রা এখনও শুরু হয়নি। আগামীকাল পরবর্তী ধাপ আনলক হবে।",
        );
      }
    }
    ...
    return (
      ...
      >
        <View style={[styles.errorContainer, { padding: theme.spacing.lg }]}>
          <Typography
            variant="subheading"
            style={[styles.errorText, { color: theme.colors.onPrimary }]}
          >
            এই ধাপের পরিকল্পনা পাওয়া যায়নি।
          </Typography>
          <TouchableOpacity
            onPress={() => router.back()}
            style={[
    ...
    >
      ...
      >
        ...
        <IslamicSection
          ...
          isBookmarked={
            islamicContent ? bookmarks.includes(islamicContent.id) : false
          }
