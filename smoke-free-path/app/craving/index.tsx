...
export default function CravingScreen() {
  ...
  const [usedStrategies, setUsedStrategies] = useState<Set<CravingStrategy>>(
    new Set(),
  );
      ...
      >
        ...
        <Card style={styles.card}>
          <Typography
            ...
            style={[styles.cardTitle, { color: theme.colors.text }]}
          >
            ক্র্যাভিংয়ের তীব্রতা
          </Typography>
          <Typography
            variant="body"
            style={[styles.cardSub, { color: theme.colors.textSecondary }]}
          >
            এখন কতটা তীব্র অনুভব করছেন? (১–১০)
          </Typography>
        ...
        <Card style={styles.card}>
          ...
          <Typography
            ...
            style={[styles.cardSub, { color: theme.colors.textSecondary }]}
          >
            কোন পরিস্থিতিতে ক্র্যাভিং হচ্ছে?
          </Typography>
          <TriggerSelector
        ...
        <Card style={styles.card}>
          ...
          {activeTab === "dua" && (
            <DuaLink onGoToDua={() => router.push("/(tabs)/dua")} />
          )}
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            <Typography
              variant="body"
              style={[styles.modalTitle, { color: theme.colors.primaryDark }]}
            >
              মাশাআল্লাহ! ৫ মিনিট পার হয়েছে!
            </Typography>
            <Typography
              variant="body"
              style={[styles.modalQuestion, { color: theme.colors.text }]}
            >
              ক্র্যাভিং কাটিয়েছেন?
            </Typography>

            <TouchableOpacity
              style={[
                styles.outcomeBtn,
                styles.outcomeBtnOvercome,
                { backgroundColor: theme.colors.primary },
              ]}
