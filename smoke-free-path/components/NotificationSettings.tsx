...
export default function NotificationSettings({
  ...
  const [osPermissionGranted, setOsPermissionGranted] = useState<
    boolean | null
  >(null);
    ...
    >
      ...
      {notificationsEnabled && osPermissionGranted === false && (
        ...
        >
          <Typography
            variant="small"
            style={{ color: theme.colors.text, lineHeight: 18 }}
          >
            ⚠️ ডিভাইসের সেটিংসে নোটিফিকেশন অফ করা আছে। অনুগ্রহ করে সেটিংসে গিয়ে
            পারমিশন দিন।
          </Typography>
        </View>
      )}
        ...
        <View style={styles.timersContainer}>
          ...
          <View style={styles.timeRow}>
            <View>
              ...
              <Typography variant="small" color="textSecondary">
                যাত্রা শুরুর দিনের প্রথম বার্তা
              </Typography>
            </View>
            <TouchableOpacity
              style={[
          ...
          <View style={styles.timeRow}>
            <View>
              ...
              <Typography variant="small" color="textSecondary">
                সারাদিন ধূমপান-মুক্ত থাকার পর বার্তা
              </Typography>
            </View>
            <TouchableOpacity
              style={[
          ...
          {/* iOS inline pickers */}
          {Platform.OS === "ios" &&
            (showMorningPicker || showEveningPicker) && (
              <DateTimePicker
                value={
                  showMorningPicker
                    ? morningValid
                      ? timeStringToDate(morningTime)
                      : new Date()
                    : eveningValid
                      ? timeStringToDate(eveningTime)
                      : new Date()
                }
                mode="time"
                display="spinner"
                onChange={
                  showMorningPicker ? handleMorningChange : handleEveningChange
                }
                style={{ height: 200 }}
              />
            )}
